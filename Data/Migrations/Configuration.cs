    ...
    public sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        protected override void Seed(Data.Context.ApplicationDbContext context)
        {
            ...
            context.MeioPagamentos.AddOrUpdate(x => x.Descricao,
              ...
              new Data.Entities.MeioPagamento { Descricao = MeioPagamentoPadraoEnum.Cheque.GetDescription(), Taxa = 0, IsEditavel = false, Status = StatusEnum.Ativo },
              new Data.Entities.MeioPagamento { Descricao = MeioPagamentoPadraoEnum.PagSeguro.GetDescription(), Taxa = 0, IsEditavel = false, Status = StatusEnum.Ativo }
            );
